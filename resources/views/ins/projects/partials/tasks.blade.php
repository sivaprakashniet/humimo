<div class="row task-list-row">
    <div class="col-xs-12 col-md-3">
        <ul class="task-list">
            <h5 class="title">Open (@{{ numOpenTasks }})</h5>
            <li v-on:click="editMode(task)" v-for="task in project.tasks | filterBy 'open' in 'state' " class="task-@{{ task.id }}" >
                <div>
    ...
    <div class="col-xs-12 col-md-2">
        <ul class="task-list">
            <h5 class="title">Resolved (@{{ numResolvedTasks }})</h5>
            <li v-on:click="editMode(task)" v-for="task in project.tasks | filterBy 'resolved' in 'state' " class="task-@{{ task.id }}" >
                <div>
                    <div class="pull-left">w.@{{ task.weight }}</div>
                    <div class="show-on-hover pull-right">
                        <span v-on:click="deleteTask(task.id, $index)" class="ion-close-round"></span>
